            ...
            <td>
                <center>
                    <fieldset style="width:400px;font-size:30px">
                        ...
                        <form actio=""
                              method="post"
                              oninput="txtr.value=parseInt(txtf.value)-parseInt(txtp.value)"
                              enctype="multipart/form-data">

                            <table border="0" align="center" width="400px" cellpadding="10"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="txtc"
                                               value="<?php echo $row['con']; ?>" required />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Qualification</td>
                                    <td>
                                        <input type="text" name="txtq"
                                               value="<?php echo $row['qal']; ?>" required />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="txtr"
                                               value="<?php echo $row['remain']; ?>" required />
                                    </td>
                                </tr>
